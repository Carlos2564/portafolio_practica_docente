...
class RecursosTecnologicosPage {
  constructor() {
    this.init();
  }
  ...
  init() {
    ...
    this.updateTime();
    console.log('✅ Página de Recursos Tecnológicos inicializada');
  }
  ...
  setupScrollAnimations() {
    ...
    // Observar tarjetas de experiencias
    document.querySelectorAll('.experiencia-card').forEach(card => {
      observer.observe(card);
    });
    
    // Observar tarjetas de aprendizajes
  ...
  setupCardAnimations() {
    ...
    herramientaCards.forEach(card => {
      card.addEventListener('mouseenter', () => {
        const icon = card.querySelector('.herramienta-icon');
        if (icon) {
    ...
    const aprendizajeCards = document.querySelectorAll('.aprendizaje-card');
    
    aprendizajeCards.forEach(card => {
      card.addEventListener('mouseenter', () => {
        const icon = card.querySelector('.aprendizaje-icon');
        if (icon) {
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('🚀 Inicializando Recursos Tecnológicos Aplicados...');
  
  // Inicializar página principal
  new RecursosTecnologicosPage();
  ...
  console.log('💻 4 herramientas digitales documentadas');
  console.log('⭐ 2 experiencias significativas');
  console.log('📚 3 aprendizajes pedagógicos');
});
